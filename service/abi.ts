...
export const SIGNAL_LEDGER_ABI = [
  "function publishSignal(string token, uint8 direction, uint8 score, uint256 entryPrice, uint256 stopPrice, uint256 targetPrice, uint256 expiresAt) returns (uint256 id)",
  "function publishSignal(string token, uint8 direction, uint8 score, uint256 entryPrice, uint256 stopPrice, uint256 targetPrice) returns (uint256 id)",
  ...
  "event SignalPublished(uint256 indexed id, string token, uint8 direction, uint8 score, uint256 entryPrice, uint256 stopPrice, uint256 targetPrice, uint256 publishedAt, uint256 expiresAt)",
