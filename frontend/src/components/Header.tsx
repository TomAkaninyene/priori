...
// Inline rather than pulling in an icon library for two glyphs. The
// accessible name lives on the enclosing <a> (aria-label + title), so these
// are hidden from assistive tech to avoid announcing twice.
function XIcon() {
  return (
    ...
    <header className="header">
      ...
      <div className="header__actions">
        <nav className="header__links">
          ...
          <span className="header__icon-links">
            <a
              href="https://x.com/priori_hq"
              target="_blank"
              rel="noreferrer"
              className="header__icon-link"
              aria-label="Priori on X"
              title="Priori on X"
            >
              <XIcon />
            </a>
            <a
              href="https://github.com/TomAkaninyene/priori"
              target="_blank"
              rel="noreferrer"
              className="header__icon-link"
              aria-label="Priori on GitHub"
              title="Priori on GitHub"
            >
              <GitHubIcon />
            </a>
          </span>
